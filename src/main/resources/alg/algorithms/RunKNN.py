...
def get_one_result(onedata, modelname, taskname):
    # 从文件加载模型
    file_path1 = os.path.join(MODEL_SAVE_DICTORY, "trained", f"KNN_{taskname}.pkl")
    file_path2 = os.path.join(MODEL_SAVE_DICTORY, 'explainer', f"KNN_{taskname}.pkl")
    file_path3 = os.path.join(MODEL_SAVE_DICTORY, 'scaler', f"KNN_{taskname}.pkl")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--modelname", type=str, default="knn")
